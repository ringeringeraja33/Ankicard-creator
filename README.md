...
- Future cards render fixed expressions and reusable structures in red and bold the key point of each explanatory bullet. Structured rich-text parts generate the styling while continuing to escape user text as data.
