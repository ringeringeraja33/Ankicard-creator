...
If the confirmed preview has no title, use `"title": ""` to omit the heading without adding unapproved text. This works with either `lines` or `items`; it does not make an empty body valid.
